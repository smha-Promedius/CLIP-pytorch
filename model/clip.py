...
class CLIPModel(nn.Module):
    def __init__(self, image_encoder, text_encoder, img_prj_head, txt_prj_head, temperature):
        super().__init__()
        self.image_encoder = image_encoder
        self.text_encoder = text_encoder
        self.image_projection = img_prj_head
        self.text_projection = txt_prj_head
